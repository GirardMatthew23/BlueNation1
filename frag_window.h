...
private:      
   ...
   bool selectSingleImage(bool picTaken );
   ...
   bool mosaicShader = false;
   bool lresample = false;
   bool start = false;
   bool colorReduce = false;
...
private slots:
   ...
   void on_actionTake_Pic_triggered();
   void on_actionLResample_triggered();
